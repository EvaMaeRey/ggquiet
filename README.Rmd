...
The goal of ggquiet is to be able to reveal components of a fully built up plot.  The strategy is to set elements to fully transparent, and then 'turn on' the element by changing the transparency to opaque. 
